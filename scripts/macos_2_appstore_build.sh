...
sed -i '' 's/"Rune Notarized";/"Rune App Store";/g' macos/Runner.xcodeproj/project.pbxproj
sed -i '' 's/"Developer ID Application";/"3rd Party Mac Developer Application";/g' macos/Runner.xcodeproj/project.pbxproj
